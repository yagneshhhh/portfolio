    ...
    <nav className={cn("fixed w-full z-40 transition-all duration-300", isScrolled ?  "py-3 bg-background/80 backdrop-blur-md shadow-xs":"py-5")}>
        <div className='container flex items-center justify-between'>
            <a className='text-xl font-bold text-primary flex items-center' href="#hero">
                ...
                <span className='text-glow text-foreground'>Yagnesh</span>{" "}
                Portfolio
                </span>
            </a>
            {/*desktop*/}
            ...
            <div className={cn("fixed inset-0 bg-backround/95 backdrop-blur-md z-40 flex flex-col items-center justify-center"
                , "tansition-all duration-300 md:hidden",
                isMenuOpen 
                ? "opacity-100 pointer-eventsa-auto" : "opacity-0 pointer-events-none"
